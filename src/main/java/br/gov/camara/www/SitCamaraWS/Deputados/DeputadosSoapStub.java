...
public class DeputadosSoapStub extends org.apache.axis.client.Stub implements
	...
	private static void _initOperationDesc1() {
		...
		oper.setReturnType(new javax.xml.namespace.QName(
				...
				">>ObterDeputadosResponse>ObterDeputadosResult"));
		...
		oper.setReturnType(new javax.xml.namespace.QName(
				"http://www.camara.gov.br/SitCamaraWS/Deputados",
				">>ObterPartidosBlocoCDResponse>ObterPartidosBlocoCDResult"));
		...
		oper.setReturnType(new javax.xml.namespace.QName(
				"http://www.camara.gov.br/SitCamaraWS/Deputados",
				">>ObterDetalhesDeputadoResponse>ObterDetalhesDeputadoResult"));
		...
		oper.setReturnType(new javax.xml.namespace.QName(
				"http://www.camara.gov.br/SitCamaraWS/Deputados",
				">>ObterLideresBancadasResponse>ObterLideresBancadasResult"));
	...
	public DeputadosSoapStub(java.net.URL endpointURL,
			javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
		this(service);
		super.cachedEndpoint = endpointURL;
	}

	public DeputadosSoapStub(javax.xml.rpc.Service service)
		...
		try {
			...
			if (_resp instanceof java.rmi.RemoteException) {
				...
				try {
					...
					return (br.gov.camara.www.SitCamaraWS.Deputados.ObterDeputadosResponseObterDeputadosResult) org.apache.axis.utils.JavaUtils
							.convert(
									_resp,
									br.gov.camara.www.SitCamaraWS.Deputados.ObterDeputadosResponseObterDeputadosResult.class);
				}
			}
		...
		try {
			...
			if (_resp instanceof java.rmi.RemoteException) {
				...
				try {
					...
					return (br.gov.camara.www.SitCamaraWS.Deputados.ObterPartidosCDResponseObterPartidosCDResult) org.apache.axis.utils.JavaUtils
							.convert(
									_resp,
									br.gov.camara.www.SitCamaraWS.Deputados.ObterPartidosCDResponseObterPartidosCDResult.class);
				}
			}
		} catch (org.apache.axis.AxisFault axisFaultException) {
			throw axisFaultException;
		...
		try {
			...
			if (_resp instanceof java.rmi.RemoteException) {
				...
				try {
					...
					return (br.gov.camara.www.SitCamaraWS.Deputados.ObterPartidosBlocoCDResponseObterPartidosBlocoCDResult) org.apache.axis.utils.JavaUtils
							.convert(
									_resp,
									br.gov.camara.www.SitCamaraWS.Deputados.ObterPartidosBlocoCDResponseObterPartidosBlocoCDResult.class);
				}
			}
		} catch (org.apache.axis.AxisFault axisFaultException) {
			throw axisFaultException;
		...
		try {
			...
			if (_resp instanceof java.rmi.RemoteException) {
				...
				try {
					...
					return (br.gov.camara.www.SitCamaraWS.Deputados.ObterDetalhesDeputadoResponseObterDetalhesDeputadoResult) org.apache.axis.utils.JavaUtils
							.convert(
									_resp,
									br.gov.camara.www.SitCamaraWS.Deputados.ObterDetalhesDeputadoResponseObterDetalhesDeputadoResult.class);
				}
			}
		} catch (org.apache.axis.AxisFault axisFaultException) {
			throw axisFaultException;
		...
		try {
			...
			if (_resp instanceof java.rmi.RemoteException) {
				...
				try {
					...
					return (br.gov.camara.www.SitCamaraWS.Deputados.ObterLideresBancadasResponseObterLideresBancadasResult) org.apache.axis.utils.JavaUtils
							.convert(
									_resp,
									br.gov.camara.www.SitCamaraWS.Deputados.ObterLideresBancadasResponseObterLideresBancadasResult.class);
				}
			}
		} catch (org.apache.axis.AxisFault axisFaultException) {
			throw axisFaultException;
