...
public class DeputadosSoapProxy implements
	...
	private void _initDeputadosSoapProxy() {
		try {
			deputadosSoap = (new br.gov.camara.www.SitCamaraWS.Deputados.DeputadosLocator())
					.getDeputadosSoap();
			if (deputadosSoap != null) {
				if (_endpoint != null)
					((javax.xml.rpc.Stub) deputadosSoap)
							._setProperty(
									"javax.xml.rpc.service.endpoint.address",
									_endpoint);
				else
					_endpoint = (String) ((javax.xml.rpc.Stub) deputadosSoap)
	...
	public void setEndpoint(String endpoint) {
		_endpoint = endpoint;
		if (deputadosSoap != null)
			((javax.xml.rpc.Stub) deputadosSoap)._setProperty(
