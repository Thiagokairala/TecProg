...
public class DeputadosLocator extends org.apache.axis.client.Service implements
		br.gov.camara.www.SitCamaraWS.Deputados.Deputados {
	...
	public DeputadosLocator(java.lang.String wsdlLoc,
	...
	public br.gov.camara.www.SitCamaraWS.Deputados.DeputadosSoap getDeputadosSoap(
		...
		try {
			br.gov.camara.www.SitCamaraWS.Deputados.DeputadosSoapStub _stub = new br.gov.camara.www.SitCamaraWS.Deputados.DeputadosSoapStub(
					portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface)
			throws javax.xml.rpc.ServiceException {
		try {
			if (br.gov.camara.www.SitCamaraWS.Deputados.DeputadosSoap.class
					.isAssignableFrom(serviceEndpointInterface)) {
				br.gov.camara.www.SitCamaraWS.Deputados.DeputadosSoapStub _stub = new br.gov.camara.www.SitCamaraWS.Deputados.DeputadosSoapStub(
						new java.net.URL(DeputadosSoap_address), this);
				_stub.setPortName(getDeputadosSoapWSDDServiceName());
				return _stub;
			}
	...
	public javax.xml.namespace.QName getServiceName() {
		return new javax.xml.namespace.QName(
				"http://www.camara.gov.br/SitCamaraWS/Deputados", "Deputados");
	}
